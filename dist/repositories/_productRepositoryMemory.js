...
exports._productRepository = {
    filterProducts(title) {
        return __awaiter(this, void 0, void 0, function* () {
            if (title) {
                return exports.products.filter(p => p.title.indexOf(title) > -1).map(getResFunctions_1.ProductMapper);
            }
            else {
                return exports.products.map(getResFunctions_1.ProductMapper);
            }
        });
    },
    findProduct(title) {
    ...
    createProduct(title) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, getResFunctions_1.ProductMapper)(exports.products[exports.products.length - 1]);
        });
    }
};
